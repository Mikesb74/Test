...
using ApiNCoreEApplication1.Api;
...
/// 
/// NOTE:
/// Must update database connection in appsettings.json - "ApiNCoreEApplication1.ApiDB"
///
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            try
            {
                ...
                {
                    c.SwaggerDoc("v1", new OpenApiInfo { Title = "ApiNCoreEApplication1 API", Version = "v1" });
                    c.SwaggerDoc("v2", new OpenApiInfo { Title = "ApiNCoreEApplication1 API", Version = "v2" });
